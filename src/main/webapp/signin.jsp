...
<main>
  ...
  <form>
    ...
    <div class="requirements">(* per registrarisi è necessario essere maggiorenni)</div><br><br> <!-- TODO controllare che l'eta sia >= 18 anni-->
    ...
    <!--  div class="alert">(* mail non valida) TODO questa cosa deve apparire solo se è vera</div>-->
    <br><br>
    ...
    <!--  div class="alert">(* username gia preso) TODO questa cosa deve apparire solo se è vera</div>--><br><br>
    ...
    <div class="requirements">(* la password deve contenere almeno 8 caratteri di cui anmeno uno maiuscolo, un numero, le lettere [E,F,G] e uno tra[$,!,?])</div><br><br>
    ...
    <!--  div class="alert">(* le password non coincidono) TODO questa cosa deve apparire solo se è vera</div>--><br><br>
